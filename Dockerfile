...
RUN pnpm --filter @logacore/cli run bundle
...
# Copy the compiled migration runner and CLI (bundled)
...
COPY --from=builder --chown=nextjs:nodejs /app/packages/cli/dist/bundle.js ./packages/cli/dist/bundle.js
